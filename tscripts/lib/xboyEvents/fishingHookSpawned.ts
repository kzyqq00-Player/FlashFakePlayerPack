...
import type {
    FishingHookDespawnedEvent,
    FishingHookDespawnedEventSignal,
    FishingHookSpawnedEvent,
    FishingHookSpawnedEventSignal
...
system.runInterval(() => {
    ...
    queue.fishingHookDespawned_HookArray.forEach((Fisher, HookId) => HookIdArray.includes(HookId) || (fishingHookDespawned.trigger({
        HookId: HookId,
        Fisher: Fisher,
